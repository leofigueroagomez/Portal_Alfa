...
| Sitio publico (SEO tecnico, indexacion y SEO local) | Activo. Fase 1 (dominio canonico + 301 heredadas) y Fase 3 (NAP, landing de ciudad, JSON-LD LocalBusiness) desplegadas 2026-09-02 | `app/robots.ts`, `app/sitemap.ts`, `app/layout.tsx`, `app/lutron-guadalajara/` | `lib/siteUrl.ts`, `lib/localBusiness.ts`, `components/LocalBusinessJsonLd.tsx`, `next.config.ts` (`legacyRedirects`) | [`../modules/sitio-publico/MODULE_CONTEXT.md`](../modules/sitio-publico/MODULE_CONTEXT.md) | Alto |
