...
const alfaOsItems = [
  { title: "Avances visibles", icon: ClipboardCheck },
  { title: "Evidencias fotográficas", icon: Camera },
  { title: "Documentación centralizada", icon: FileStack },
  { title: "Historial y soporte", icon: CheckCircle2 },
];
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="border border-[#B84A5A]/30 bg-[#7A1F2B]/18 p-7 sm:p-9">
            ...
            <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">
              Transparencia total del proyecto, de principio a soporte.
            </h2>
            <p className="mt-5 text-base leading-8 text-zinc-300">
              ALFA OS permite consultar el avance, las evidencias y la
              documentación relevante en un solo lugar, para que cada decisión
              tenga contexto y cada entrega quede respaldada.
            </p>
          </div>
